...
```javascript
variance = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-variance@v0.0.10-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-variance@v0.0.10-umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/stats-base-variance/actions/workflows/test.yml/badge.svg?branch=v0.0.10
[test-url]: https://github.com/stdlib-js/stats-base-variance/actions/workflows/test.yml?query=branch:v0.0.10
